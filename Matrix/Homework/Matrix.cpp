...
template<typename T>
T** Matrix::_create_matrix(int _size, T** matrix)
{
...
template<typename T>
void Matrix::_set_cero(int _size, T** matrix)
{
	for (int i = 0; i < _size; i++) {
...
template<typename T>
void Matrix::_input_num(T** matrix, string input_text, int _size)
{
    Input input;
	for (int i = 0; i < _size; i++) {
		for (int j = 0; j < _size; j++) {
...
template<typename T>
void Matrix::_print_matrix(T** matrix, int _size)
{
	for (int i = 0; i < _size; i++) {
		for (int j = 0; j < _size; j++) {
			cout << *(*(matrix + i) + j) << ", ";
...
template<typename T>
void Matrix::_change_matrix(T** matrix, T** matrix_for_change, int _size)
{
	for (int i = 0; i < _size; i++) {
		for (int j = 0; j < _size; j++) {
