...
*/
template<typename T>
int Menu::options(const char* message, T* option, int index) {
    int selection = 1;
    int key;
    bool flag = true;
    do {
...
*/
template<typename T>
int Menu::options(const char* message, T* option, int index, int color) {
    int selection = 1;
    int key;
    bool flag = true;
    do {
 ...
 * @return int
*/
int Menu::yes_no_option(const char* message, int color) {
 ...
 * @return int
*/
int Menu::yes_no_option(const char* message) {
    char** _yes_no = (char**)malloc(2 * sizeof(char*));
    *(_yes_no + 0) = (char*)"SI";
    *(_yes_no + 1) = (char*)"NO";
